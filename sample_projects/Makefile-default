...
# sample projects 	
list-projects:
	@echo "Sample projects: template2D chemotaxis2D random_cell_placement differential_motility template3D biorobots-sample cancer-biorobots-sample heterogeneity-sample"
...
differential_motility:
	cp ./sample_projects/differential_motility/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./sample_projects/differential_motility/main-2D.cpp ./main.cpp 
	cp Makefile Makefile-backup
	cp ./sample_projects/differential_motility/Makefile .
	cp ./config/PhysiCell_settings.xml ./config/PhysiCell_settings-backup.xml 
	cp ./sample_projects/differential_motility/config/* ./config/
...
random_cell_placement:
	cp ./sample_projects/random_cell_placement/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./sample_projects/random_cell_placement/main-2D.cpp ./main.cpp
	cp Makefile Makefile-backup
	cp ./sample_projects/random_cell_placement/Makefile .
	cp ./config/PhysiCell_settings.xml ./config/PhysiCell_settings-backup.xml
	cp ./sample_projects/random_cell_placement/config/* ./config/	
